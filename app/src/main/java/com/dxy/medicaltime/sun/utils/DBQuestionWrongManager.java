 ...
 */
public class DBQuestionWrongManager {
    private Context context;
    public static final String DB_NAME="questionwrong.db";

    public static DBQuestionWrongManager dbManager;

    public static DBQuestionWrongManager getDbManager(Context context){
        if (dbManager==null){
            synchronized (DBQuestionWrongManager.class){
                if(dbManager==null){
                    dbManager=new DBQuestionWrongManager(context);
                }
            }
        }
        return dbManager;
    ...
    public DBQuestionWrongManager(Context context) {
