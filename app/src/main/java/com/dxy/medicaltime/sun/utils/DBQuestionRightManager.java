 ...
 */
public class DBQuestionRightManager {
    private Context context;
    public static final String DB_NAME="questionright.db";

    public static DBQuestionRightManager dbManager;

    public static DBQuestionRightManager getDbManager(Context context){
        if (dbManager==null){
            synchronized (DBQuestionRightManager.class){
                if(dbManager==null){
                    dbManager=new DBQuestionRightManager(context);
                }
            }
        }
        return dbManager;
    ...
    public DBQuestionRightManager(Context context) {
